...
import { getProductById, mockWarehousesFlat } from '@/data/mock';
...
export default function ProductBatchCreate() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    // Aqui deve entrar insert real em batches e, se necessário, movimento de entrada.
      ...
      <div className="bg-surface-raised border border-border rounded-xl p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Select
            ...
            options={mockWarehousesFlat.map(w => ({ value: w.id, label: w.name }))}
          />
